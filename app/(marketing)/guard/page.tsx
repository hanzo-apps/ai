    ...
    <>
      ...
      <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden py-20 px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative z-10 max-w-5xl mx-auto text-center">
          ...
          >
            Stop prompt injection, PII leaks, and unsafe outputs before they
            reach your users. Guard sits between your application and any LLM
            provider, enforcing policy on every request and response.
          </motion.p>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              A layered set of detectors and policies that ship with sane
              defaults and extend to your domain.
            </p>
          </motion.div>
