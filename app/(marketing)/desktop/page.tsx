    ...
    <>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 border-t border-border">
        <Box className="max-w-4xl mx-auto text-center">
          ...
          <Box className="grid grid-cols-3 gap-6 max-w-2xl mx-auto">
            <Box className="bg-secondary/50 border border-border rounded-xl p-6">
              <Apple className="w-8 h-8 mx-auto mb-3 text-foreground" />
              <Box className="text-foreground font-medium">macOS</Box>
              <Box className="text-sm text-muted-foreground">arm64 + intel</Box>
            </Box>
            <Box className="bg-secondary/50 border border-border rounded-xl p-6">
              <MonitorSmartphone className="w-8 h-8 mx-auto mb-3 text-foreground" />
              <Box className="text-foreground font-medium">Windows</Box>
              <Box className="text-sm text-muted-foreground">x64 + arm64</Box>
            </Box>
            <Box className="bg-secondary/50 border border-border rounded-xl p-6">
              <Zap className="w-8 h-8 mx-auto mb-3 text-foreground" />
              <Box className="text-foreground font-medium">Linux</Box>
              <Box className="text-sm text-muted-foreground">deb + rpm + AppImage</Box>
            </Box>
          </Box>
        </Box>
      </section>
