...
export const metadata: Metadata = pageMeta({
  ...
  description: 'Hanzo delivers a unified ecosystem of AI Cloud infrastructure, developer platforms, and expert consulting to transform how enterprises build, deploy, and…',
  path: '/solutions',
})
