      ...
      <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden py-20 px-4 sm:px-6 lg:px-8">
        ...
        <Box className="relative z-10 max-w-5xl mx-auto text-center">
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.25 }} className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-12 max-w-3xl mx-auto">
            <Box className="bg-secondary/50 border border-border rounded-xl p-4"><Box className="text-2xl font-bold text-foreground">Atomic</Box><Box className="text-sm text-muted-foreground">Postings</Box></Box>
            <Box className="bg-secondary/50 border border-border rounded-xl p-4"><Box className="text-2xl font-bold text-foreground">Reverts</Box><Box className="text-sm text-muted-foreground">Never edits</Box></Box>
            <Box className="bg-secondary/50 border border-border rounded-xl p-4"><Box className="text-2xl font-bold text-foreground">USD/2</Box><Box className="text-sm text-muted-foreground">Assets carry precision</Box></Box>
            <Box className="bg-secondary/50 border border-border rounded-xl p-4"><Box className="text-2xl font-bold text-foreground">Numscript</Box><Box className="text-sm text-muted-foreground">Money-movement DSL</Box></Box>
          </motion.div>
