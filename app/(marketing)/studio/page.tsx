...
export const metadata: Metadata = {
  ...
  description:
    'Hanzo Studio is a visual AI engine for generative media. Wire models, prompts, and tools into a node graph and generate images, video, audio, and 3D — no code. Open source (GPL-3.0); run it on your own GPU or use the managed studio on Hanzo Cloud.',
  openGraph: {
    title: 'Hanzo Studio — the visual AI engine for generative media',
    description:
