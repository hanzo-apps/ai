          ...
          <div className="relative bg-primary/10 border border-border rounded-xl p-8 overflow-hidden">
            ...
            <pre className="text-sm sm:text-base overflow-x-auto bg-[var(--black)]/50 p-4 rounded-lg border border-white/30">
              <code className="text-foreground/80">
                ...
                <br/>
                <span className="ml-4 text-foreground">const</span> <span className="text-[var(--white)]">{'{'} data {'}'} = </span><span className="text-foreground">await</span> <span className="text-[var(--white)]">req.json();</span>
                <br/>
                <span className="ml-4 text-foreground">const</span> <span className="text-[var(--white)]">result = </span><span className="text-foreground">await</span> <span className="text-foreground/70">processData</span><span className="text-[var(--white)]">(data);</span>
                <br/>
                <br/>
                <span className="ml-4">// Return JSON response</span>
                <br/>
                <span className="ml-4 text-foreground">return</span> <span className="text-[var(--white)]">Response.json({'{'}</span>
                <br/>
                <span className="ml-8">success: <span className="text-foreground/60">true</span>,</span>
                <br/>
      ...
      <section className="py-16 border-t border-neutral-800">
        <div className="max-w-3xl mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <a href="https://docs.hanzo.ai/functions" target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-2 bg-primary text-primary-foreground hover:bg-primary/90 px-6 py-3 rounded-md text-sm font-medium">
              Read the docs <ArrowRight className="h-4 w-4" />
            </a>
            <a href="https://github.com/hanzoai/functions" target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-2 border border-border hover:bg-accent px-6 py-3 rounded-md text-sm font-medium">
              View on GitHub
            </a>
          </div>
        </div>
