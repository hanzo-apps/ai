        ...
        <Box className="relative z-10 max-w-5xl mx-auto text-center">
          ...
          >
            <Box className="bg-secondary/50 border border-border rounded-xl p-4">
              <Box className="text-2xl font-bold text-foreground">Library</Box>
              <Box className="text-sm text-muted-foreground">No broker to run</Box>
            </Box>
            <Box className="bg-secondary/50 border border-border rounded-xl p-4">
              <Box className="text-2xl font-bold text-foreground">Cron</Box>
              <Box className="text-sm text-muted-foreground">Scheduling</Box>
            </Box>
            <Box className="bg-secondary/50 border border-border rounded-xl p-4">
              <Box className="text-2xl font-bold text-foreground">Retries</Box>
              <Box className="text-sm text-muted-foreground">With backoff</Box>
            </Box>
            <Box className="bg-secondary/50 border border-border rounded-xl p-4">
              <Box className="text-2xl font-bold text-foreground">At-least-once</Box>
              <Box className="text-sm text-muted-foreground">Delivery</Box>
            </Box>
          </motion.div>
