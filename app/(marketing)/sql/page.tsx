      ...
      <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden py-20 px-4 sm:px-6 lg:px-8">
        ...
        <Box className="relative z-10 max-w-5xl mx-auto text-center">
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.25 }} className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-12 max-w-3xl mx-auto">
            ...
            <Box className="bg-secondary/50 border border-border rounded-xl p-4"><Box className="text-2xl font-bold text-foreground">pgvector</Box><Box className="text-sm text-muted-foreground">Already on</Box></Box>
            <Box className="bg-secondary/50 border border-border rounded-xl p-4"><Box className="text-2xl font-bold text-foreground">WAL</Box><Box className="text-sm text-muted-foreground">Restore to a second</Box></Box>
          </motion.div>
