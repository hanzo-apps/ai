...
export const metadata: Metadata = pageMeta({
  title: 'Hanzo PubSub',
  description: 'Managed NATS with JetStream for durable messaging. At-least-once delivery, key-value stores, object stores, and request-reply patterns.',
  path: '/pubsub',
  other: goImport('pubsub'),
})
