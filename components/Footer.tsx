...
const footerLinks = {
  ...
  solutions: {
    title: "Solutions",
    items: [
      { title: "AI agents", href: "/solutions/agents" },
      { title: "RAG", href: "/solutions/rag" },
      { title: "Realtime", href: "/solutions/realtime" },
      { title: "Fine-tuning", href: "/solutions/fine-tuning" },
      { title: "Healthcare", href: "/solutions/industries/healthcare" },
      { title: "Financial services", href: "/solutions/industries/finance" },
      { title: "Enterprise", href: "/solutions/industries/enterprise" },
      { title: "All solutions", href: "/solutions", highlight: true },
    ],
  },
  models: {
    title: "Models",
