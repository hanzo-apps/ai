        ...
        <div className="relative z-10 h-full px-4 sm:px-6 md:px-10 lg:px-12 py-10 sm:py-12 lg:py-16">
          ...
          */}
            ...
            <div className="flex flex-col min-w-0">
              ...
              >
                Not another AI API. Hanzo is a decentralized cloud powered by hanzo.network — <code className="font-mono text-foreground/90 text-[0.9em]">hanzod</code> nodes spawn the same unified <code className="font-mono text-foreground/90 text-[0.9em]">cloud</code> binary we run in production. Every capability behind one API. Open source, one binary. Bring your own GPU or Kubernetes, or run it all on your laptop. Connect any provider, watch usage and cost in one place, and let the native router serve the most optimal model — <span className="text-foreground font-medium">saving up to 90% on compute</span>.
              </motion.p>
