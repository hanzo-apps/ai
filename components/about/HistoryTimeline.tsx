  ...
  return (
    ...
    >
      <Box className="md:w-1/2">
        <Box className="bg-card backdrop-blur-sm border border-border rounded-lg p-8 h-full">
          <Box className="flex items-center mb-4">
            <Box className="p-3 rounded-full bg-accent mr-4">
              {event.icon}
            </Box>
            <div>
          ...
          <Box className="bg-primary/10 border border-border rounded-lg p-4 mb-6">
      ...
      <Box className="hidden md:block md:w-1/2" aria-hidden />
      <motion.div
        initial={{ scale: 1 }}
        whileInView={{ scale: 1 }}
        viewport={{ once: true, margin: "0px 0px -20% 0px" }}
  ...
  return (
    <section id="timeline" className="py-24 px-4 sm:px-6 lg:px-8">
      <Box className="max-w-7xl mx-auto">
        ...
        <Box ref={rail} className="mt-16 relative">
