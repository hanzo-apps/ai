          ...
          >
            <div className="bg-gradient-to-br from-white/20 to-transparent rounded-2xl p-1">
              <div className="bg-card backdrop-blur-sm rounded-xl overflow-hidden border border-border">
                <div className="w-full h-56 rounded-t-xl bg-gradient-to-br from-white/25 via-background/40 to-white/10 border-b border-border flex items-center justify-center">
                  <div className="text-center">
                    <div className="text-xs uppercase tracking-widest text-muted-foreground">Sensei Method</div>
