      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-wrap justify-center gap-8 mb-16">
          {techStacks.map((tech, index) => (
            <motion.div
              ...
              className="px-6 py-3 bg-neutral-800/50 rounded-full border border-neutral-700 hover:border-white/30 hover:bg-neutral-800 transition-colors"
            >
              {tech}
            </motion.div>
          ))}
        ...
        >
          ...
          <motion.a
            ...
            className="inline-block px-8 py-4 rounded-lg bg-[var(--white)] text-primary-foreground font-medium hover:shadow-lg hover:shadow-white/20 transition-all"
          >
