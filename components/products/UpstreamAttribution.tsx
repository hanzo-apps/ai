            ...
            <div className="flex-1">
              ...
              <div className="flex flex-wrap gap-3">
                <a
                  ...
                  className="inline-flex items-center gap-2 px-4 py-2 bg-neutral-800 hover:bg-neutral-700 border border-border rounded-lg text-sm font-medium text-foreground transition-colors"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 px-4 py-2 bg-transparent hover:bg-accent border border-border rounded-lg text-sm font-medium text-foreground/80 transition-colors"
                >
                  Visit {upstream.name}
                  <ExternalLink className="w-3 h-3" />
                </a>
