        ...
        <Box className="max-w-3xl mx-auto">
          <Box className="bg-neutral-900/50 border border-neutral-800 rounded-xl p-8">
            ...
            <p className="text-foreground/80 mb-6">
              ...
              <a href="https://www.papermark.io" target="_blank" rel="noopener noreferrer" className="text-[var(--white)] underline underline-offset-4 hover:text-white/70 transition-colors">
                Papermark
              </a>
