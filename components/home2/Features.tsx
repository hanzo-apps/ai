...
const features = [
  ...
  },
  {
    ...
    description: "Enterprise security with GDPR controls and 99.9% uptime SLA."
  },
  {
  ...
  return (
    <section className="py-20 relative">
      <div className="container mx-auto px-4">
        ...
        <Box className="mt-16 bg-gray-900/30 border border-gray-800 rounded-xl p-8 max-w-5xl mx-auto">
          <Box className="flex flex-col md:flex-row items-center">
            <Box className="flex-1 mb-8 md:mb-0 md:mr-8">
            ...
            <Box className="flex-1 bg-gray-950 p-4 rounded-lg font-mono text-sm overflow-auto">
