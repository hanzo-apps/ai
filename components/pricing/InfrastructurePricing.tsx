  ...
  return (
    <>
      ...
      <Box className="mb-12">
        ...
        <Box className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-4">
          {visiblePlans.map((plan) => (
            <div key={plan.id} className={`rounded-xl p-6 border transition-colors ${
              ...
              <Box className="text-2xl font-bold mb-1">{formatPrice(plan.priceMonthly)}<span className="text-base font-normal text-muted-foreground">/mo</span></Box>
              <Box className="text-xs text-muted-foreground mb-4">${plan.priceHourly.toFixed(4)}/hr</Box>
        ...
        {regions.length > 0 && (
          <Box className="flex flex-wrap gap-3 text-sm text-muted-foreground">
      ...
      {blockStorage && blockStorage.pricePerGBMonthly > 0 && (
        <Box className="mb-12">
          ...
          <Box className="bg-neutral-900/30 rounded-xl p-6 border border-neutral-800/50 inline-block">
            <Box className="text-3xl font-bold mb-1">${blockStorage.pricePerGBMonthly}<span className="text-lg font-normal text-muted-foreground">/GB/mo</span></Box>
