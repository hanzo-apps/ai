      ...
      <Box className="relative z-10 max-w-4xl mx-auto text-center">
        ...
        >
          <Box className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/5 border border-border mb-8">
            ...
            <span className="text-sm font-medium text-foreground/70">Hanzo Search</span>
          </Box>
          ...
          <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
            ...
            <br />
            <span className="text-foreground/70">Full-text, vector, hybrid, and RAG -- all from one API.</span>
          </p>
