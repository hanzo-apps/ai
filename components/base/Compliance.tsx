...
const Compliance = () => {
  return (
    <section className="py-12 px-4 sm:px-6 lg:px-8 bg-neutral-900/30">
        ...
        >
          <Box className="flex flex-col md:flex-row items-center justify-between">
            <Box className="mb-8 md:mb-0">
              ...
              <Box className="mt-4 flex flex-wrap gap-4">
                <Box className="flex items-center bg-primary/10 border border-white/30 rounded-md px-3 py-1">
          ...
          >
            ...
            <Box className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6">
              <Box className="bg-primary/10 border border-white/30 rounded-lg p-4">
