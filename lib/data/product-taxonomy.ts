...
export const dataProducts: Product[] = [
  ...
  },
  {
    ...
    github: 'https://github.com/hanzoai',
    docs: 'https://docs.hanzo.ai/docs/docdb',
    install: {
  ...
  },
  {
    ...
    description: 'Real-time analytics database for massive datasets. Columnar OLAP at scale.',
    category: 'data',
    icon: 'BarChart3',
  ...
  },
  {
    ...
    tagline: 'Vector search in Datastore',
...
export const asyncProducts: Product[] = [
  ...
  },
  {
    ...
    github: 'https://github.com/hanzoai',
    docs: 'https://docs.hanzo.ai/docs/tasks',
    install: {
...
export const mlProducts: Product[] = [
  ...
  },
  {
    ...
    github: 'https://github.com/hanzoai',
    docs: 'https://docs.hanzo.ai/docs/services/ml',
  ...
  },
  {
    ...
    docs: 'https://docs.hanzo.ai/docs/services/models',
  ...
  },
  {
    ...
    github: 'https://github.com/hanzoai',
    docs: 'https://docs.hanzo.ai/docs/skills/hanzo-kensho',
  ...
  },
  {
    ...
    github: 'https://github.com/hanzoai',
    docs: 'https://docs.hanzo.ai/docs/skills/hanzo-jin',
...
export const observabilityProducts: Product[] = [
  {
    ...
    github: 'https://github.com/hanzoai/o11y',
...
export const platformProducts: Product[] = [
  ...
  },
  {
    ...
    github: 'https://github.com/hanzoai',
    docs: 'https://docs.hanzo.ai/docs/skills/hanzo-hke',
    install: {
  ...
  },
  {
    ...
    docs: 'https://docs.hanzo.ai/docs/kms',
...
export const appsProducts: Product[] = [
  ...
  },
  {
    ...
    docs: 'https://docs.hanzo.ai/docs/chat',
  ...
  },
  {
    ...
    docs: 'https://docs.hanzo.ai/docs/mcp',
    install: {
...
export const growthProducts: Product[] = [
  ...
  },
  {
    ...
    github: 'https://github.com/hanzoai',
    docs: 'https://docs.hanzo.ai/docs/analytics',
    install: {
  ...
  },
  {
    ...
    github: 'https://github.com/hanzoai',
    docs: 'https://docs.hanzo.ai/docs/openapi/ads',
