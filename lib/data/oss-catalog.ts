...
export const featuredCollections: FeaturedCollection[] = [
  ...
  },
  {
    ...
    description: 'Vector search + AI models + SQL',
    repos: ['vector', 'sql', 'gateway'],
    icon: Search,
  },
  {
    id: 'deploy-mcp',
...
export const ossCatalog: OSSRepo[] = [
  // ===== CORE INFRASTRUCTURE =====
  {
    ...
    actions: {
      ...
      docsUrl: 'https://docs.hanzo.ai/docs/dev',
  ...
  },
  {
    ...
    name: 'Hanzo AI',
    slug: 'hanzoai/ai',
    description: 'One API for every model. OpenAI- and Anthropic-compatible, with load balancing, caching, and observability.',
    type: 'core',
  ...
  // ===== SDKs =====
  {
    ...
    description: 'Flagship Python SDK — models, agents, tools, memory, and the full Hanzo cloud. pip install hanzo.',
    type: 'sdk',
    ...
    actions: {
      ...
      pypiUrl: 'https://pypi.org/project/hanzo/',
    },
    signals: {
  ...
  },
  {
    ...
    name: 'TypeScript SDK',
    slug: 'hanzo-js/sdk',
    description: 'Full cloud SDK for TypeScript/JavaScript. Works in Node.js, browsers, and edge runtimes.',
    type: 'sdk',
    categories: ['Developer Tools'],
    languages: ['TypeScript'],
    useCases: ['Inference Gateway', 'Multi-agent'],
  ...
  },
  {
    ...
    name: 'Go SDK',
    slug: 'hanzo-go/sdk',
    description: 'Full cloud SDK for Go. Idiomatic Go with context support and connection pooling.',
    type: 'sdk',
    categories: ['Developer Tools'],
    languages: ['Go'],
    ...
    actions: {
      ...
      githubUrl: 'https://github.com/hanzo-go/sdk',
    },
    signals: {
  ...
  },
  {
    ...
    name: 'Rust SDK',
    slug: 'hanzo-rs/sdk',
    description: 'The Rust stack — one umbrella crate (cargo add hanzo) re-exporting crypto, DID, MCP, agents, and embeddings, feature-gated.',
    type: 'sdk',
    categories: ['Developer Tools'],
    languages: ['Rust'],
    useCases: ['Inference Gateway'],
    ...
    actions: {
      ...
      githubUrl: 'https://github.com/hanzo-rs/sdk',
    },
    signals: {
  ...
  },
  {
    ...
    actions: {
      ...
      githubUrl: 'https://github.com/hanzo-cpp/sdk',
    },
    signals: {
  ...
  },
  {
    ...
    description: 'Full cloud SDK for Swift. Idiomatic async/await SwiftPM package for iOS, macOS, and server-side Swift.',
    type: 'sdk',
    categories: ['Developer Tools'],
    languages: ['Swift'],
    useCases: ['Inference Gateway'],
