...
export const productsMetadata: Record<string, ProductMetadata> = {
  ...
  docdb:        { slug: 'docdb',      tagline: 'Document DB over PostgreSQL', license: 'Apache-2.0', github_repo: G, upstream_fork: 'FerretDB', upstream_license: 'Apache-2.0', upstream_url: 'https://www.ferretdb.com' },
